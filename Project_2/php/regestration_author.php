...
if ($user_password !== $repeatpass) {
    ...
    alert("Спробуйте знову");
    window.location.href = "../html/register_author.html";  // Перенаправлення на сторінку реєстрації
  </script>';
    exit(); 
}
...
if ($count > 0) {
    echo '<script>
            ...
            window.location.href = "../html/register_author.html";  // Перенаправлення на форму реєстрації
          </script>';
    exit();  
}
...
if ($stmt) {
    ...
    echo '<script>
            alert("Ласкаво просимо! Автор: ' . $first_name . '!");
          </script>';
    echo '<script>
            setTimeout(function() {
                window.location.href = "../html/page_author_.html";  // Перенаправлення на сторінку автора
            }, 0000);  // Без затримки
          </script>';
} else {
